...
export default {
  ...
  'dashboard.no_displays_desc': 'Installez l\'application SLI-Signs sur votre TV et appariez-la avec le bouton ci-dessus.',
  ...
  'settings.hide_branding': 'Masquer la marque « SLI-Signs »',
  ...
  'settings.setup_step_1': 'Installez l\'APK SLI-Signs sur votre TV via le sideloading',
  ...
  'settings.import.invalid_file': 'Fichier invalide. Doit être un JSON ou ZIP d\'export SLI-Signs.',
  ...
  'onboarding.step.welcome.title': 'Bienvenue sur SLI-Signs !',
