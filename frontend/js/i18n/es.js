...
export default {
  ...
  'dashboard.no_displays_desc': 'Instala la aplicación de SLI-Signs en tu TV y vincúlala con el botón de arriba.',
  ...
  'settings.hide_branding': 'Ocultar la marca "SLI-Signs"',
  ...
  'settings.setup_step_1': 'Instala el APK de SLI-Signs en tu TV mediante sideloading',
  ...
  'settings.import.invalid_file': 'Archivo no válido. Debe ser un JSON o ZIP de exportación de SLI-Signs.',
  ...
  'onboarding.step.welcome.title': '¡Bienvenido a SLI-Signs!',
